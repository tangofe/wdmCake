...
<!--link-->
  <div id="cnt"><!--cnt--->
    ...
    <div id="updata_lanmu"><!--管理栏目-->
      	...
      	<?php
      		include('../Api/editCategoryApi.php');
      	 ?>
	<table width="803" border="0" cellspacing="0" cellpadding="0">
		...
		<?php
			...
			foreach($rows as $row){
				$tab.='<tr>
					<td width="113"><a href="../View/upCategory.php?lid=1&act=getCategory&id='.$row['id'].'&pid='.$row['pid'].'   ">编辑</a><a href="../Api/upCategoryApi.php?act=deleteCategory&id='.$row['id'].'  ">删除</a></td>
